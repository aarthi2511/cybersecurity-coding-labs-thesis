#!/usr/bin/env python3
"""
Pytest Test Suite for Intrusion Detection System - REFERENCE SOLUTION

Comprehensive test suite covering all 6 detection algorithms with
positive cases, negative cases, and edge cases.

Run:
    pytest test_detector.py -v
    pytest test_detector.py -v --tb=short
    pytest test_detector.py -k "brute_force"   # run subset by keyword
    pytest test_detector.py --cov=detector      # with coverage (needs pytest-cov)
...
@pytest.fixture
def base_time():
    """Fixed reference timestamp for reproducible test data."""
