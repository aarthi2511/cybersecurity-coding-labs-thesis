...
class GeoLocator:
    ...
    def __init__(self):
        ...
        # Simulated geolocation database
        # Includes all possible random IPs that students might get
        self.geo_database = {
    ...
    def is_suspicious_country(self, country_code: str) -> bool:
        """
        Check if country is on suspicious list.
        
        Args:
            country_code: Two-letter country code
            
        Returns:
            True if country is suspicious
        """
    ...
    def get_distance(self, country1: str, country2: str) -> Optional[int]:
        """
        Get approximate distance between two countries.
        ...
        Returns:
            Distance in kilometers, or None if same country
        """
        if country1 == country2:
            return 0
        
        # Try both orderings (US,CN) and (CN,US)
